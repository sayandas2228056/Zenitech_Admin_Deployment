            ...
            <div className="flex items-center justify-between pt-3 gap-3">
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="px-3 py-2 rounded-xl border border-orange-200 bg-white text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-400/40 focus:border-orange-400 transition"
                >
